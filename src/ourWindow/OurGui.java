...
public class OurGui extends Application {
	...
	//ABBLIDUNG 5 Beleuchtung 2
		...
		public  Sphere sphereTex = new Sphere(new SingleColorMaterial(new ImageTexture(new raytracer.Color(0,0,0),"jupitermap320.jpg")));
	    public  Sphere sphereTexInt = new Sphere(new SingleColorMaterial(new InterpolatedImageTexture(new raytracer.Color(0,0,0),"jupitermap320.jpg")));
